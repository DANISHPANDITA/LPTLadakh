    ...
    >
      <div className="flex flex-row items-center">
        <Fade triggerOnce={true} delay={1200}>
          <div className="xs:w-16 xs:h-auto">
            <Image
              src={logo.logoImg}
              onClick={() => {
                router.push("/");
              }}
              className="rounded-full hover:opacity-95 hover:scale-95 transition-all duration-200 hover:cursor-pointer "
              width={100}
              height={100}
              alt=""
            />
        ...
        <div className="flex flex-col items-center">
          <Fade delay={1400} bottom triggerOnce={true}>
            <p className="font-extrabold text-2xl italic text-[#122937] ml-2 xs:text-sm sm:text-lg md:text-xl">
      ...
      <div className="flex flex-row items-center space-x-3 font-extrabold xs:hidden sm:hidden md:hidden">
          ...
          >
            <MenuHandler>
              <IconButton className="p-1 xs:p-0.5 bg-gray-900">
                <i
                  aria-label="Menu"
                  className="fa-solid fa-bars p-3 xs:p-1  text-white"
                />
              </IconButton>
            </MenuHandler>
            <MenuList className="font-semibold bg-gray-100  p-1 xs:p-0 sm:p-0 sm:text-base xs:text-sm">
              <MenuItem
